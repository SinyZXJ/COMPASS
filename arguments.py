...
class Arguments:
    def __init__(self):
        ...
        self.high_info_thre = math.exp(-0.5)  # 用来判断高信息区域，所谓adaptive
        ...
        self.load_model = True # 从checkpoints开始继续训练
        self.use_wandb = False
        if self.use_wandb:
            self.project_name = 'STAMP'
            self.wandb_notes = ''
            self.wandb_id = ''
        self.save_img_gap = 2000  # 是否保存可视化的图像
        self.save_files = True  # 是否保存模型文件
